...
export const EMPLOYEES: Employee[] = [
  ...
  },
  {
    profile: {
      name: 'Sasmita',
      title: $localize`:@@employeesData.coFounder:Co-Founder`,
      bio: $localize`:@@employees.fatih.bio:Sasmita is a young professional with wide-ranging experience in software design and technology. He worked several years on Finance and Telecom business areas. He is now a Founder and CEO at Remoklify. He also co-founded Open Template Hub.`,
      photoUri:
  ...
  },
  {
    profile: {
      ...
      bio: $localize`:@@employees.mert.bio:Ritesh is a new grad software engineer who has been experienced various technologies in his bachelor years. He worked on e-commercial and banking areas. Now, he is a full-stack developer at Open Template Hub and also working on native iOS applications.`,
      photoUri:
