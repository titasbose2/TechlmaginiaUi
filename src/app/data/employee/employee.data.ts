...
export const EMPLOYEES: Employee[] = [
  {
    profile: {
      ...
      social: {
        ...
        // mail: 'mailto:hr@techlmaginia.in'
      },
    }
  },
  {
    profile: {
      name: 'Sasmita',
      title: $localize`:@@employeesData.coFounder:Co-Founder`,
      bio: $localize`:@@employees.fatih.bio:Sasmita is a young professional with wide-ranging experience in software design and technology. She worked several years on Finance and Telecom business areas. She is now a Founder and CEO at Remoklify. She also co-founded Techlmaginia Softwares.`,
      photoUri:
  ...
  },
  {
    profile: {
      ...
      bio: $localize`:@@employees.mert.bio:Ritesh is a new grad software engineer who has been experienced various technologies in his bachelor years. He worked on e-commercial and banking areas. Now, he is a full-stack developer at Techlmaginia Softwares and also working on native iOS applications.`,
      photoUri:
  ...
  },
  {
    profile: {
      ...
      bio: $localize`:@@employees.???.bio:Would you like to join our team? Please feel free to reach us from hr@techlmaginia.in or from jobs page.`,
      photoUri:
          '',
      social: {
