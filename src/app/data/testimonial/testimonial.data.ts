...
export const TESTIMONIALS: Testimonial[] = [
  {
    review: $localize`:@@testimonials.review.adamNolan:I can say, without a doubt, that Techlmaginia Softwares\'s products scale quickly and provide the best performance in the market. The best part is that we don\'t have to worry about any licensing fees at all... I highly recommend this affordable and reliable products!`,
    reviewer: {
      name: 'Adam Nolan',
  ...
  {
    review: $localize`:@@testimonials.review.claudiaGoodwin:As a startup, time is of the essence for us. That\'s why Techlmaginia Softwares has been so helpful for us. It has saved us hours of time when it comes to creating the perfect website for our company.`,
    reviewer: {
  ...
  {
    review: $localize`:@@testimonials.review.leeRees:Techlmaginia Softwares\'s Orchestration Server was easy to set up and integrate with our existing servers. I liked how the system automatically synced over all of the latest updates, it made managing our company\'s server so much easier. The customer service is also top-notch!`,
    reviewer: {
      name: 'Lee Rees',
  ...
  {
    review: $localize`:@@testimonials.review.caseyCarlson:I\'m a big fan of Techlmaginia Softwares. The process was really easy, the team is efficient, and the payment service is really accurate. I would recommend this to any business owner.`,
    reviewer: {
      name: 'Casey Carlson',
  ...
  {
    review: $localize`:@@testimonials.review.???:Would you like to tell us how was your Techlmaginia Softwares experience or are you planning to use our products but need some professional help? Please feel free to reach us from hr@techlmaginia.in or from contact us page.`,
    reviewer: {
      name: '???',
